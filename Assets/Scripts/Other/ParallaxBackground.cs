...
public class ParallaxBackground : MonoBehaviour
{
    ...
    [SerializeField]private Transform mainCameraTrans; // 主摄像机的Transform组件
    [SerializeField]private Vector3 lastCameraPosition; // 上一帧摄像机的位置
    [SerializeField]private float textureUnitSizeX; // 背景图单位尺寸

    [SerializeField]public Vector2 followWeight; // 跟随摄像机的权重
